...
class EventListener extends Main implements Listener {
  ...
  public function onExpChange(PlayerExperienceChangeEvent $event) {
    ...
    if($p instanceof Player && $p->getLevel()->getName() == $this->getOwner()->config->get("RPGworld")) {
      if($this->getOwner()->playerclass->get($p->getName()) === "mage" && $event->getExp() >= 170) {
      ...
      } elseif($this->getOwner()->playerclass->get($p->getName()) === "assassin" && $event->getExp() >= 170) {
      ...
      } elseif($this->getOwner()->playerclass->get($p->getName()) === "tanker" && $event->getExp() >= 170) {
      ...
      } elseif($this->getOwner()->playerclass->get($p->getName()) === "warrior" && $event->getExp() >= 170) {
